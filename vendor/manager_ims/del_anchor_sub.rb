...
# Скрипт удаления абонента NGN из анкоринга IMS.
require 'rubygems'
...
puts "Removing a subscriber NGN to the IMS."
puts '*' * 43
puts
...
puts ats.cmd("MOD VSBR: D=K'#{number}, LP=0, CSC=0;")[:successful]

print 'Modify CNACLD'.ljust(25)
puts ats.cmd("MOD CNACLD: LP=0, PFX=K'#{number}, EA=YES, SPCHG=NOSPCHG;")[:successful]
